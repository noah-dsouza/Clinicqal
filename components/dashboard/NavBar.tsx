      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <span className="text-base font-bold text-foreground">ClinIQ</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            {twin && (
              <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-muted border border-border">
                <div className="w-6 h-6 rounded-full bg-[rgba(13,148,136,0.15)] flex items-center justify-center">
                  <span className="text-[#0D9488] text-xs font-bold">{twin.intake.demographics.age}</span>
                </div>
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs font-medium rounded-lg border border-border text-muted-foreground hover:text-foreground hover:border-border/80 transition-colors"
            >
              Retake Intake
            </button>
          </div>
          ...
          {TABS.map((tab) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-all ${
                activeTab === tab.id ? "bg-[rgba(13,148,136,0.1)] text-[#0D9488]" : "text-muted-foreground"
              }`}
            >
              {tab.label}
            </button>

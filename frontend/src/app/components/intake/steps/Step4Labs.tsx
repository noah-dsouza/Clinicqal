...
export function Step4Labs({ labs, onChange }: Props) {
  ...
  return (
    <div className="fade-in-up">
      <h2 className="text-xl font-bold text-[#2F3E34] mb-1">Laboratory Results</h2>
      ...
      <div className="mb-5">
        <p className="text-xs text-[#8B7765] mb-2 uppercase tracking-wide">
      ...
      <div className="space-y-3">
        ...
        {labs.length === 0 && (
          <div className="py-8 text-center border border-dashed border-[rgba(47,62,52,0.12)] rounded-lg">
            <p className="text-[#8B7765] text-sm">No lab results added yet</p>
            <p className="text-[#6B7F6A] text-xs mt-1">

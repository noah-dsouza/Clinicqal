  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderRadius: 12,
        border: `1px solid ${hovered ? "rgba(134,239,172,0.55)" : "rgba(47,62,52,0.1)"}`,
        background: "#FFFFFF",
        boxShadow: hovered ? "0 20px 50px rgba(134,239,172,0.18), 0 0 20px rgba(134,239,172,0.1)" : "none",

...
function CriterionRow({ criterion }: { criterion: CriterionMatch }) {
  ...
  return (
    <div className="flex items-start gap-3 py-3 border-b border-[rgba(255,255,255,0.05)] last:border-0">
...
export function EligibilityDrawer({ trial, isOpen, onClose, onAnalyze, isAnalyzing }: EligibilityDrawerProps) {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 h-full w-full max-w-lg z-50 flex flex-col overflow-hidden"
        ...
        <div className="shrink-0 px-5 pt-5 pb-4 border-b" style={{ borderColor: "rgba(255,255,255,0.07)" }}>
          <div className="flex items-start justify-between gap-3 mb-3">
            ...
            <button onClick={onClose} className="p-1.5 rounded-lg transition-colors shrink-0" style={{ color: "#64748B" }}>
        ...
        <div className="flex-1 overflow-y-auto">
          {hasResult ? (
            <div className="px-5 py-5 space-y-4">
              <div className="rounded-xl p-4 border flex items-center gap-4" style={{ background: `${recColor}08`, borderColor: `${recColor}20` }}>
              ...
              <div className="rounded-xl p-4 border" style={{ background: "rgba(20,184,166,0.06)", borderColor: "rgba(20,184,166,0.15)" }}>
              ...
              {match.key_concerns.length > 0 && (
                <div className="rounded-xl p-4 border" style={{ background: "rgba(251,191,36,0.05)", borderColor: "rgba(251,191,36,0.15)" }}>
          ...
          <div className="px-5 pb-5 space-y-4 border-t pt-4" style={{ borderColor: "rgba(255,255,255,0.07)" }}>
            ...
            <a href={trial.url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-xs text-[#14B8A6] hover:text-[#2DD4BF] transition-colors">
